...
### Assignment Due Thursday 12/9/21

For this week's assignment, you should use the new dataset I will send you by email to: (1) estimate a linear regression of *y* on *x* using the uncensored dataset; (2) create a censored version of the dataset using the censoring rule provided in the email; (3) estimate a new linear regression of *y* on *x* using the censored data; (4) compare the uncensored and censored results; (5) estimate a censored regression model of *y* on *x*; (6) compare the results of the censored regression model to those from the 2 linear regression models you previously estimated; (7) calculate the difference between the 2 medians and use the bootstrap to assess the statistical significance of the difference between the 2 medians.
