...
* b. Draw a simple random sample of 300 observations from this population; calculate the mean of your sample (2pts).
...
* d. Conduct a simulation study with 10,000 datasets and random samples of size N = 300 to document the coverage rate for your confidence interval procedure (9pts).
